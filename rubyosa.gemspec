Gem::Specification.new do |s|
    ...
    s.files = ['README', 'COPYRIGHT', 'AUTHORS', 'extconf.rb', 'src/rbosa.c', 'src/rbosa.h', 'src/rbosa_conv.c', 'src/rbosa_sdef.c', 'src/lib/rbosa.rb', 'sample/Finder_show_desktop.rb', 'sample/iChat_uptime.rb', 'sample/iTunes_control.rb', 'sample/iTunes_fade_volume.rb', 'sample/iTunes_inspect.rb', 'sample/QT_playall.rb', 'sample/sdef.rb']
